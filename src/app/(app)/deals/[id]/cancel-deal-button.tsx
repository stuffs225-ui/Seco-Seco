...
/**
 * إلغاء صفقة لم يُسجَّل عليها أي شيء غير التسليم الأول — خطأ إدخال
 * (موزع غلط، وزن غلط) اكتُشف فوراً. `eligible` مبنية في الصفحة نفسها
 * من طول دفتر الحركات المجلوب أصلاً — لا استعلام إضافي، ومجرد نسخة
 * مبكرة من حارس القاعدة الحقيقي في cancel_deal.
 */
  ...
  return (
    ...
    >
      ...
      <p className="text-negative text-xs font-medium">
        سيُلغى التسليم بالكامل ويعود الوزن للمخزون — لا تراجع بعد التأكيد.
      </p>
      <input
        name="reason"
        required
