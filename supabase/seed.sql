...
-- ── حساب المالك ────────────────────────────────────────────────────────
--
-- النظام يفتح بلا تسجيل دخول، لكن هذا الحساب ضروري لا اختياري: كل
-- سياسات RLS وسجل التدقيق مبنية على auth.uid()، والنظام يعمل تحت هويته.
--
-- كلمة المرور عشوائية بلا مستخدم: لا شاشة دخول، والجلسة تُنشأ برمز رابط
-- سحري يولّده مفتاح الإدارة.
--
...
-- gotrue يتطلب سجل هوية مطابقاً حتى يقبل توليد الرابط السحري للبريد
...
--
-- (أو استخدم docs/bootstrap.sql الذي يفعل هذا وما قبله بلصقة واحدة)
--
-- 1) Supabase Dashboard → Authentication → Users → Add user
--    فعّل "Auto Confirm User" — البريد المؤكَّد شرط لتوليد رمز الجلسة.
--
